 ...
 *
 */
public class Perf_mod_page1_BUDev_Test extends AutomationTest_ISSD {
...
//		new Object[] { "Rx Brands","Generic Molecules","Generic Suppliers" };// "OTC Categories","Generic Suppliers", "Generic Molecules"
	...
	public void login(String username, String password,String sheetName,String modulePages) {
		...
		try {
			...
			new userAutomationLibrary().captureScreen(driver, "Test", "PASS", "OpenURL");
			login_page.login_check(username, password);
			 Thread.sleep(38000);
		} catch (Exception e) {
			new userAutomationLibrary().captureScreen(driver, "Test", "FAIL", "OpenURL");
		}
	...
	public void menuSelect(String menu) throws InterruptedException  {
		...
		try {
			...
			new userAutomationLibrary().captureScreen(driver, "Test", "PASS", "First page");
		} catch (Exception e) {
			new userAutomationLibrary().captureScreen(driver, "Test", "FAIL", "First page");
		}
...
//		menu_page.manf_menu_click(menu);
	...
	public void csvSaveFile(String menu, List<String> dataRows)  {
		...
		new userAutomationLibrary().csvFileWrite("Test_" + menu, sb1);
	}
