 ...
 *
 */
public class Manf_page1_Prod_Automation extends AutomationTest_ISSD {
...
//		new Object[] { "Rx Brands","Generic Molecules","Generic Suppliers" };// "OTC Categories","Generic Suppliers", "Generic Molecules"
	...
	public void login(String username, String password,String sheetName,String modulePages) {
		...
		try {
			...
			new userAutomationLibrary().captureScreen(driver, "ProductionTest", "PASS", "OpenURL");
			login_page.login_check(username, password);
			 Thread.sleep(38000);
		} catch (Exception e) {
			new userAutomationLibrary().captureScreen(driver, "ProductionTest", "FAIL", "OpenURL");
		}
		 ...
		 dc_page.link_check();
			...
			driver.switchTo().frame(driver.findElement(By.xpath("//iframe[@id='MSOPageViewerWebPart_WebPartWPQ1']")));
				try {
			Thread.sleep(38000);
	...
	public void menuSelect(String menu) throws InterruptedException  {
		...
		try {
			...
			new userAutomationLibrary().captureScreen(driver, "ProductionTest", "PASS", "First page");
		} catch (Exception e) {
			new userAutomationLibrary().captureScreen(driver, "ProductionTest", "FAIL", "First page");
		}
	...
	public void csvSaveFile(String menu, List<String> dataRows)  {
		...
		new userAutomationLibrary().csvFileWrite("ProductionTest_" + menu, sb1);
	}
