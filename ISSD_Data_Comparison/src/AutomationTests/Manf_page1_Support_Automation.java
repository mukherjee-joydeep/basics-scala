 ...
 *
 */
public class Manf_page1_Support_Automation extends AutomationTest_ISSD {
...
//		new Object[] { "Rx Brands","Generic Molecules","Generic Suppliers" };// "OTC Categories","Generic Suppliers", "Generic Molecules"
	...
	public void login(String username, String password,String sheetName,String modulePages) {
		...
		try {
			...
			new userAutomationLibrary().captureScreen(driver, "SupportTest", "PASS", "OpenURL");
			login_page.login_check(username, password);
			 Thread.sleep(38000);
		} catch (Exception e) {
			new userAutomationLibrary().captureScreen(driver, "SupportTest", "FAIL", "OpenURL");
		}
	...
	public void menuSelect(String menu) throws InterruptedException  {
		...
		try {
			...
			new userAutomationLibrary().captureScreen(driver, "SupportTest", "PASS", "First page");
		} catch (Exception e) {
			new userAutomationLibrary().captureScreen(driver, "SupportTest", "FAIL", "First page");
		}
	...
	public void csvSaveFile(String menu, List<String> dataRows)  {
		...
		new userAutomationLibrary().csvFileWrite("SupportTest_" + menu, sb1);
	}
